                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="product_name" name="product_name" value="{{old('product_name',$editdata->name)}}" >
                              ...
                              <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="price" name="price" value="{{old('price',$editdata->price)}}" required>
                                @if ($errors->has('price'))
                            ...
                            <select class="form-control" name="category" id="category" required>
                              ...
                              @if (!empty($categories))
                                  @foreach ($categories as $item)
                                      <option value="{{$item->id}}" {{ old('category') == $item->id || $editdata->category_id == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                  @endforeach
                              @endif
                            </select>
