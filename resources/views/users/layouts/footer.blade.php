            ...
            <footer class="section-footer border-top">
                <div class="container-fluid">
                            ...
                            <aside class="col-md-4">
                                <article class="mr-3"> <img src="https://i.imgur.com/S5Zdt8L.png"
                                    ...
                                    <div> <a class="btn btn-icon btn-light" title="Facebook" target="_blank"
                                            ...
                                            href="#" data-abc="true"><i class="fab fa-instagram"></i></a> <a
                                            class="btn btn-icon btn-light" title="Youtube" target="_blank"
                                            href="#" data-abc="true"><i class="fab fa-youtube"></i></a> <a
                                            class="btn btn-icon btn-light" title="Twitter" target="_blank"
                                            href="#" data-abc="true"><i class="fab fa-twitter"></i></a> </div>
                                </article>
                            </aside>
                    ...
                    <section class="footer-copyright border-top">
                        ...
                        <p target="_blank" class="float-right text-muted"> <a href="#" data-abc="true">Privacy
                                &amp; Cookies</a> &nbsp; &nbsp; <a href="#" data-abc="true">Accessibility</a>
                        </p>
                    </section>
                </div>
            </footer>
